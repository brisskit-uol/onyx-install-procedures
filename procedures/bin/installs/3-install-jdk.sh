...
cp $WORK_DIR/$ACQUISITIONS_DIRECTORY/$JDK_PACKAGE $ONYX_INSTALL_DIRECTORY

# This section required for binary execution install of package
chmod u+x $ONYX_INSTALL_DIRECTORY/$JDK_PACKAGE
cd $ONYX_INSTALL_DIRECTORY
./$JDK_PACKAGE

# This section required for tar install of package
# Untar the install package...
#cd $ONYX_INSTALL_DIRECTORY
#tar -xvf $ONYX_INSTALL_DIRECTORY/$JDK_PACKAGE

rm $ONYX_INSTALL_DIRECTORY/$JDK_PACKAGE
cd $ONYX_INSTALL_PROCS_HOME/bin/installs

#
# Give jdk a symbolic link...
ln -s $ONYX_INSTALL_DIRECTORY/$JDK $ONYX_INSTALL_DIRECTORY/jdk 
