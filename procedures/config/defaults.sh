...
export TOMCAT_DOWNLOAD_PATH=http://maven.brisskit.org/nexus/content/repositories/thirdparty/apache/tomcat/apache-tomcat/6.0.35/apache-tomcat-6.0.35.zip
export ONYX_DOWNLOAD_PATH=http://maven.brisskit.org/nexus/content/repositories/thirdparty/onyx/brisskit-onyx-demo/1.8.1/brisskit-onyx-demo-1.8.1-apptlistfix.war
export ONYX_INTEGRATION_WS_DOWNLOAD_PATH=http://maven.brisskit.org/nexus/content/repositories/releases/org/brisskit/app/onyx/onyxWS/1.0-RC1/onyxWS-1.0-RC1.war
export ONYX_PROCEDURES_DOWNLOAD_PATH=http://maven.brisskit.org/nexus/content/repositories/releases/org/brisskit/app/onyx/onyx-admin-procedures/1.0-RC1-development/onyx-admin-procedures-1.0-RC1-development.zip
